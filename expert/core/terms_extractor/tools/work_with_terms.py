...
def load_terms(dict_name: Dictionary) -> Dict[str, List[str]]:
    ...
    """
    dict_map = {
        Dictionary.EN4: "./weights/terms_extractor/en_term_index.pickle",
        Dictionary.EN3_5: "./weights/terms_extractor/en_term_index_3.5.pickle",
        Dictionary.RU4: "./weights/terms_extractor/ru_term_index_4.pickle",
        Dictionary.RU3_5: "./weights/terms_extractor/ru_term_index_3.5.pickle",
    }
