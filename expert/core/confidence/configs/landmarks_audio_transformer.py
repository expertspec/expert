...
model = dict(
    ...
    init_cfg=dict(type="PretrainedInit", checkpoint="D:\\Python\\MVP\\MVP_solvency\\ml-server\\app\\libs\\expert\\expert\\core\\confidence\\weights\\landmarks_audio_transformer.pth"),
)
