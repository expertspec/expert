...
class EvasiveAnswers:
    def __init__(self):
        ...
        self.ev_detection = pipeline("question-answering", model=self.MODEL_PATH)
    ...
    def get_evas_info(self, question: str, answer: str) -> List:
        ...
        except Exception:  # if answer length is too long, a neutral label is assigned
            return ['neutral', -1, '']
...
class QuestionStatement:
    def __init__(self):
        ...
        self.qs_classifier = pipeline("text-classification", model=self.MODEL_PATH)
    ...
    def get_qs_label(self, text: str) -> int:
        ...
        try:
            if self.qs_classifier(text)[0]['label'] == 'LABEL_1':
                ...
                return 0
        except RuntimeError:  # if sentence length is too long, is becomes a statement
            return 0
